  ...
  return (
    <div className="home-page d-flex">
          ...
          <Row>
            <Col md={4}>
              <Card className="mb-3">
                ...
                <Card.Body>
                  <Card.Title>Daily Practices Drawing</Card.Title>
            ...
            <Col md={4}>
              <Card className="mb-3">
                <Card.Img variant="top" src="https://via.placeholder.com/150" />
                <Card.Body>
                  <Card.Title>The Power of Procreate</Card.Title>
            ...
            <Col md={4}>
              <Card className="mb-3">
                <Card.Img variant="top" src="https://via.placeholder.com/150" />
                <Card.Body>
                  <Card.Title>Expressive Sketching</Card.Title>
      ...
      <div className="right-sidebar p-3">
        ...
        <Card className="mb-3">
          <Card.Body>
            Adobe Illustrator Training (50%)
          </Card.Body>
        </Card>
        <Card className="mb-3">
          <Card.Body>
            Hand-Painted Textures (30%)
          </Card.Body>
        </Card>
      </div>
    </div>
